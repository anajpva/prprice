...
public class PriceMother {
  ...
  private static final Instant ONE_START_DATE = OffsetDateTime.parse("2020-06-13T21:00:00Z").toInstant();

  private static final Instant ONE_END_DATE = OffsetDateTime.parse("2020-06-16T20:00:00Z").toInstant();
